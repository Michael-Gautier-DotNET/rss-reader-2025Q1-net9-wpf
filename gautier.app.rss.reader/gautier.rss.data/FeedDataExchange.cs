...
{
    public static class feed_data_exchange
    {
        public static SortedList<string, Feed> get_all_feeds(string sqlConnectionString)
        {
        ...
        public static SortedList<string, SortedList<string, FeedArticle>> get_all_feed_articles(string sqlConnectionString)
        {
            var feeds_articles = new SortedList<string, SortedList<string, FeedArticle>>();
            ...
            using (var sql_conn = new SqlConnection(sqlConnectionString))
            {
                ...
                using (var sql_com = sql_conn.CreateCommand())
                {
                    ...
                    using (var col_reader = sql_com.ExecuteReader())
                    {
                        ...
                        while (col_reader.Read())
                        {
                            var feed_article_item = new FeedArticle();
                            ...
                            {
                                feeds_articles[feed_article_item.feed_name] = new SortedList<string, FeedArticle>();
                            }
